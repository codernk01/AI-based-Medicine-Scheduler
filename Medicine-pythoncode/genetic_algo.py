...
class Geneticalgorithm:
    ...
    def init_population(self, schedules):
        ...
        Arguments:
            schedules: List, population of medicine schedules.
        """
        self.population = []
    ...
    def mutate(self, eiltePopulation):
        ...
        for p in ep:
            ...
            if pos==0:
                p.slot = self.addSub(p.slot, operation, 14)
            if pos==1:
                p.weekDay = self.addSub(p.weekDay, operation, 3)
...
#        pos = np.random.randint(0, 2, 1)[0]
    ...
    def evolution(self, schedules):
        ...
        Arguments:
            schedules: medicine schedules for optimization.
